...
#
#   Generated Mon Dec 12 19:38:50 2016  by jolsson
#
#====================================
...
#cmt_local_tagfile_install_joboptions = $(MLTree_tag)_install_joboptions.make
...
#cmt_local_tagfile_install_joboptions = $(MLTree_tag).make
...
#cmt_final_setup_install_joboptions = $(bin)MLTree_install_joboptionssetup.make
...
#cmt_final_setup_install_joboptions = $(bin)MLTreesetup.make
cmt_local_install_joboptions_makefile = $(bin)install_joboptions.make
...
install_dir = ${installarea}/jobOptions/MLTree
...
MLTreeMaker_py_dependencies = ../share/MLTreeMaker.py


install_joboptionsinstall :: ${install_dir}/MLTreeMaker.py ;

${install_dir}/MLTreeMaker.py :: ../share/MLTreeMaker.py
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../share/MLTreeMaker.py`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "MLTreeMaker.py" "$(install_dir)" "/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.7.7/AtlasCore/20.7.7/External/ExternalPolicy/src/symlink.sh" "$($(package)_cmtpath)"; \
	fi

../share/MLTreeMaker.py : ;
...
install_joboptionsuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "MLTreeMaker.py" "$(install_dir)" "$($(package)_cmtpath)"; \
	fi
