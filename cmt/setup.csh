...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=MLTree -version=MLTree-00-00-00 -path=/share/home/jolsson/workarea/MLTreeAthenaAnalysis  -no_cleanup $* >${cmtMLTreetempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=MLTree -version=MLTree-00-00-00 -path=/share/home/jolsson/workarea/MLTreeAthenaAnalysis  -no_cleanup $* >${cmtMLTreetempfile}"
